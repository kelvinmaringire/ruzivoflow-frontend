    ...
    <q-tabs
        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="yesterday">
            ...
            <q-table
              dense
              title="Home or Draw (Yesterday)"
              class="my-sticky-header-table my-sticky-column-table"
              :rows="bettingTipsStore.yesterday_home_draw"
              :columns="columns"
              :filter="filter"
          ...
          <q-tab-panel name="today">
            ...
            <q-table
              dense
              title="Home or Draw (Today)"
              class="my-sticky-header-table my-sticky-column-table"
              :rows="bettingTipsStore.today_home_draw"
              :columns="columns"
              :filter="filter"
              :pagination="initialPagination"
              no-data-label="I didn't find anything for you"
          ...
          <q-tab-panel name="tomorrow">
            ...
            <q-table
              dense
              title="Home or Draw (Tomorrow)"
              class="my-sticky-header-table my-sticky-column-table"
              :rows="bettingTipsStore.tomorrow_home_draw"
              :columns="columns"
              :filter="filter"
              :pagination="initialPagination"
              no-data-label="I didn't find anything for you"
